...
if __name__ == '__main__':
    ...
    parser.add_argument('--instances', action="store", help='Number of instances; think about license limitations (6 seems to be xilinx\'s limit). The max is the number of processors.',default=6)

...
Ideally every branch has its own register in the table but considering the amount of conditional branches that can be present in a program this is obviously not the case as is discussed further on in this paper. \todo[inline]{Vertel waar in de text en probeer obviously te veranderen}
...
\todo[inline]{Bedoel je prediction for a branch?}
